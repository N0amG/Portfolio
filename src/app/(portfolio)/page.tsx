              ...
              <div>
                ...
                <div className="mt-12">
                  ...
                  <div className="flex gap-4">
                    ...
                    <motion.a whileHover={{ scale: 1.15, rotate: -5 }} className="flex h-12 w-12 items-center justify-center rounded-xl bg-base-content/5 text-base-content hover:bg-secondary hover:text-white transition-colors" href="#" aria-label="LinkedIn">
