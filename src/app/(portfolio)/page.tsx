        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto" style={{ perspective: "800px" }}>
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/contact"
                className="btn btn-ghost rounded-full border border-secondary/30 text-secondary hover:bg-secondary/10 px-8 py-4 text-lg font-bold"
              >
                Me contacter
              </Link>
            </motion.div>
            ...
            <AnimatedSection delay={0.2} animation="fade-left">
              ...
              <div className="mt-10 grid grid-cols-2 gap-6">
                <div className="glass-card p-6 rounded-xl">
                  ...
                  <p className="text-sm text-base-content/40 mt-2">React, Next.js, Tailwind CSS, TypeScript, Django</p>
                </div>
                <div className="glass-card p-6 rounded-xl">
                  <svg className="h-6 w-6 text-secondary mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm text-base-content/40 mt-2">Python, Django, NestJS, PostgreSQL, Express</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
      ...
      <section className="py-24 px-6" id="projects">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <AnimatedSection>
              <h2 className="text-secondary text-sm font-bold tracking-widest uppercase mb-4">Portfolio</h2>
              ...
              <div>
                ...
                <div className="mt-12">
                  ...
                  <div className="flex gap-4">
                    <motion.a whileHover={{ scale: 1.15, rotate: 5 }} className="flex h-12 w-12 items-center justify-center rounded-xl bg-base-content/5 text-base-content hover:bg-primary hover:text-white transition-colors" href="https://github.com/N0amG" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    ...
                    <motion.a whileHover={{ scale: 1.15, rotate: -5 }} className="flex h-12 w-12 items-center justify-center rounded-xl bg-base-content/5 text-base-content hover:bg-secondary hover:text-white transition-colors" href="https://www.linkedin.com/in/noam-guez-0ba691261/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
