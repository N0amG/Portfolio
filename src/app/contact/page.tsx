                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-4">
                      {[
                        ...
                        <motion.a
                          key={social.label}
                          className="h-10 w-10 flex items-center justify-center rounded-full border border-base-content/10 hover:bg-primary hover:border-primary hover:text-primary-content transition-all text-base-content/60"
                          href={social.href}
